"""
Django settings for TALLER_SCIACA project.
...
SECRET_KEY = 'django-insecure-ltxbcd(0e^_!h92e@v&7y$1&3pk3$!k9kxfab&(umfkf@nak+e'
...
ROOT_URLCONF = 'TALLER_SCIACA.urls'
...
WSGI_APPLICATION = 'TALLER_SCIACA.wsgi.application'
